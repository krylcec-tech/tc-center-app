...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex font-sans text-slate-800 relative selection:bg-orange-200">
      ...
      {/* --- Main Content --- 
          ✨ ปรับแต่งตรงนี้: ใช้ flex-1 lg:ml-72 และสร้าง wrapper ด้านในเพื่อจำกัดความกว้างและจัดให้อยู่ตรงกลาง */}
      <main className="flex-1 lg:ml-72 overflow-y-auto hide-scrollbar relative z-10 w-full">
        {/* ✨ Wrapper ที่จะจัดให้อยู่ตรงกลาง (mx-auto) */}
        <div className="w-full max-w-5xl mx-auto p-6 md:p-10 lg:p-14 pb-32">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
              ...
              <Link href="/student/courses" className="bg-slate-900 text-white p-5 md:p-6 rounded-[2rem] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all group flex flex-col justify-between h-36 border border-slate-800 text-left relative overflow-hidden">
                ...
                <div className="text-left relative z-10">
                  <h3 className="font-black text-sm md:text-base leading-tight text-left">ซื้อคอร์ส / ชม.</h3>
                  <p className="text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 text-left">Shop Courses</p>
                </div>
              </Link>
              ...
              <Link href="/student/booking-flow" className="bg-white p-5 md:p-6 rounded-[2rem] shadow-sm border border-blue-100 hover:shadow-md hover:border-blue-300 transition-all group flex flex-col justify-between h-36 text-left">
                ...
                <div className="text-left">
                  <h3 className="font-black text-slate-800 text-sm md:text-base leading-tight text-left">จองคิวเรียน</h3>
                  <p className="text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 text-left">Book a Class</p>
                </div>
              </Link>
              ...
              <Link href="/student/my-schedule" className="bg-white p-5 md:p-6 rounded-[2rem] shadow-sm border border-pink-100 hover:shadow-md hover:border-pink-300 transition-all group flex flex-col justify-between h-36 text-left">
                ...
                <div className="text-left">
                  <h3 className="font-black text-slate-800 text-sm md:text-base leading-tight text-left">ตารางเรียน</h3>
                  <p className="text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 text-left">My Schedule</p>
                </div>
              </Link>
              ...
              <Link href="/student/my-books" className="bg-gradient-to-br from-orange-400 to-orange-500 text-white p-5 md:p-6 rounded-[2rem] shadow-lg shadow-orange-200 hover:shadow-xl hover:shadow-orange-300 hover:-translate-y-1 transition-all group flex flex-col justify-between h-36 border border-orange-300 text-left relative overflow-hidden">
                ...
                <div className="text-left relative z-10">
                  <h3 className="font-black text-sm md:text-base leading-tight text-left text-white drop-shadow-sm">คลังชีทนักเรียน /<br/>ระบบขายชีท</h3>
                  <p className="text-[9px] md:text-[10px] text-orange-100 font-bold uppercase tracking-widest mt-1 text-left">My Books</p>
                </div>
              </Link>
              ...
              <Link href="/student/tutors" className="bg-white p-5 md:p-6 rounded-[2rem] shadow-sm border border-emerald-100 hover:shadow-md hover:border-emerald-300 transition-all group flex flex-col justify-between h-36 text-left">
                ...
                <div className="text-left">
                  <h3 className="font-black text-slate-800 text-sm md:text-base leading-tight text-left">ทำเนียบติวเตอร์</h3>
                  <p className="text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1 text-left">Tutors Catalog</p>
                </div>
              </Link>
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-[3rem] p-8 border border-blue-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8 mb-6 relative overflow-hidden group text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 relative z-10 text-left w-full md:w-auto">
              ...
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-black text-slate-800 mb-1">ชวนเพื่อนเรียน รับแต้มฟรี! 🎁</h3>
                <p className="text-slate-500 font-bold text-sm">ให้เพื่อนกรอกรหัสของคุณตอนสมัคร เพื่อรับแต้มสะสม</p>
              </div>
            </div>
            <div className="flex items-center gap-2 bg-white p-2 pl-6 rounded-[1.5rem] border border-blue-200 relative z-10 w-full md:w-auto shadow-sm">
          ...
          <Link href="/student/affiliate/shop" className="block bg-gradient-to-r from-orange-500 to-pink-500 rounded-[3rem] p-8 md:p-10 text-white shadow-[0_8px_30px_rgba(249,115,22,0.3)] hover:shadow-[0_12px_40px_rgba(236,72,153,0.4)] transition-all group relative overflow-hidden text-left hover:-translate-y-1">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between relative z-10 gap-6">
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-white/20 backdrop-blur-md rounded-[1.5rem] flex items-center justify-center shadow-inner shrink-0 border border-white/30"><Gift size={32}/></div>
                <div>
                  <h3 className="text-2xl md:text-3xl font-black mb-1">ร้านค้าเด็กขยัน (Reward Shop)</h3>
                  <p className="text-white/90 font-bold text-sm">ใช้แต้มสะสมแลกรับของรางวัลพิเศษมากมาย คุ้มสุดๆ!</p>
                </div>
              </div>
              <div className="flex items-center justify-center gap-2 font-black text-sm uppercase tracking-widest bg-white text-orange-600 px-6 py-3 rounded-[1.2rem] shadow-md group-hover:scale-105 transition-transform w-full md:w-auto text-center">
